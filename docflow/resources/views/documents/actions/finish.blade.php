...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    <form action="{{ route('documents.finish_store', ['document' => $document->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <h4 class="text-success"><i>Ֆայլերի ցանկ</i></h4>
                        ...
                        <button type="submit" class="btn btn-success float-end mt-5">{{ trans('actions.finish') }}</button>
                    </form>
                </div>
            </div>
        </div>
